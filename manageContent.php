				...
				<div id="USheading">
					...
					<div id="UScontent" style="display:none">
						...
						<div id="USMA" style="display:none">
							<h4 onclick="show('USMAP')" class="sub-sub-category">-- Presentations</h4>
							<div id="USMAP" style="display:none" class="media-box">
								<?php content('US', 'MA', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('USMAMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="USMAMS" style="display:none" class="media-box">
								<?php content('US', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('USMAV')" class="sub-sub-category">-- Videos</h4>
							<div id="USMAV" style="display:none" class="media-box">
								<?php content('US', 'MA', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('USMAPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="USLS" style="display:none">
							<h4 onclick="show('USLSP')" class="sub-sub-category">-- Presentations</h4>
							<div id="USLSP" style="display:none" class="media-box">
								<?php content('US', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('USLSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('USLSV')" class="sub-sub-category">-- Videos</h4>
							...
							<h4 onclick="show('USLSPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="USHB" style="display:none" class="sub-category">
							<h4 onclick="show('USHBP')" class="sub-sub-category">-- Presentations</h4>
							<div id="USHBP" style="display:none" class="media-box">
								<?php content('US', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('USHBMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="USHBMS" style="display:none" class="media-box">
								<?php content('US', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('USHBV')" class="sub-sub-category">-- Videos</h4>
							<div id="USHBV" style="display:none" class="media-box">
								<?php content('US', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('USHBPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="USCC" style="display:none" class="sub-category">
							<h4 onclick="show('USCCP')" class="sub-sub-category">-- Presentations</h4>
							<div id="USCCP" style="display:none" class="media-box">
								<?php content('US', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('USCCMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="USCCMS" style="display:none" class="media-box">
								<?php content('US', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('USCCV')" class="sub-sub-category">-- Videos</h4>
							<div id="USCCV" style="display:none" class="media-box">
								<?php content('US', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('USCCPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
				...
				<div id="NLheading">
					...
					<div id="NLcontent" style="display:none">
						...
						<div id="NLMA" style="display:none" class="sub-category">
							...
							<h4 onclick="show('NLMAMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="NLMAMS" style="display:none" class="media-box">
								<?php content('NL', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('NLMAV')" class="sub-sub-category">-- Videos</h4>
						...
						<div id="NLLS" style="display:none" class="sub-category" class="sub-category">
							<h4 onclick="show('NLLSP')" class="sub-sub-category">-- Presentations</h4>
							<div id="NLLSP" style="display:none" class="media-box">
								<?php content('NL', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('NLLSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('NLLSV')" class="sub-sub-category">-- Videos</h4>
							...
							<h4 onclick="show('NLLSPL')"  class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="NLHB" style="display:none" class="sub-category" class="sub-category">
							<h4 onclick="show('NLHBP')"  class="sub-sub-category">-- Presentations</h4>
							<div id="NLHBP" style="display:none"  class="media-box">
								<?php content('NL', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('NLHBMS')"  class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="NLHBMS" style="display:none"  class="media-box">
								<?php content('NL', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('NLHBV')"  class="sub-sub-category">-- Videos</h4>
							<div id="NLHBV" style="display:none"  class="media-box">
								<?php content('NL', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('NLHBPL')"  class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="NLCC" style="display:none" class="sub-category"  class="sub-category">
							<h4 onclick="show('NLCCP')"  class="sub-sub-category">-- Presentations</h4>
							<div id="NLCCP" style="display:none" class="media-box">
								<?php content('NL', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('NLCCMS')"  class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="NLCCMS" style="display:none" class="media-box">
								<?php content('NL', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('NLCCV')"  class="sub-sub-category">-- Videos</h4>
							<div id="NLCCV" style="display:none" class="media-box">
								<?php content('NL', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('NLCCPL')"  class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="NLBS" style="display:none" class="sub-category">
							<h4 onclick="show('NLBSMS')"  class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="NLBSMS" style="display:none" class="media-box">
								<?php content('NL', 'BS', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('NLBSPL')"  class="sub-sub-category">-- Pricelists / Local Content</h4>
				...
				<div id="SEheading">
					...
					<div id="SEcontent" style="display:none">
						...
						<div id="SEMA" style="display:none" class="sub-category">
							<h4 onclick="show('SEMAP')"  class="sub-sub-category">-- Presentations</h4>
							<div id="SEMAP" style="display:none"  class="media-box">
								<?php content('SE', 'MA', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('SEMAMS')"  class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="SEMAMS" style="display:none"  class="media-box">
								<?php content('SE', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('SEMAV')"  class="sub-sub-category">-- Videos</h4>
							<div id="SEMAV" style="display:none"  class="media-box">
								<?php content('SE', 'MA', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('SEMAPL')"  class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="SELS" style="display:none" class="sub-category"  class="sub-category">
							<h4 onclick="show('SELSP')"  class="sub-sub-category">-- Presentations</h4>
							<div id="SELSP" style="display:none"  class="media-box">
								<?php content('SE', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('SELSMS')"  class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('SELSV')"  class="sub-sub-category">-- Videos</h4>
						...
						<div id="SEHB" style="display:none" class="sub-category">
							<h4 onclick="show('SEHBP')" class="sub-sub-category">-- Presentations</h4>
							<div id="SEHBP" style="display:none" class="media-box">
								<?php content('SE', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('SEHBMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="SEHBMS" style="display:none" class="media-box">
								<?php content('SE', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('SEHBV')" class="sub-sub-category">-- Videos</h4>
							<div id="SEHBV" style="display:none" class="media-box">
								<?php content('SE', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('SEHBPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="SECC" style="display:none" class="sub-category">
							<h4 onclick="show('SECCP')" class="sub-sub-category">-- Presentations</h4>
							<div id="SECCP" style="display:none" class="media-box">
								<?php content('SE', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('SECCMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="SECCMS" style="display:none" class="media-box">
								<?php content('SE', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('SECCV')" class="sub-sub-category">-- Videos</h4>
							<div id="SECCV" style="display:none" class="media-box">
								<?php content('SE', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('SECCPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
				...
				<div id="CAheading">
					...
					<div id="CAcontent" style="display:none">
						...
						<div id="CAMA" style="display:none" class="sub-category">
							<h4 onclick="show('CAMAP')" class="sub-sub-category">-- Presentations</h4>
							<div id="CAMAP" style="display:none" class="media-box">
								<?php content('CA', 'MA', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('CAMAMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="CAMAMS" style="display:none" class="media-box">
								<?php content('CA', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('CAMAV')" class="sub-sub-category">-- Videos</h4>
							<div id="CAMAV" style="display:none" class="media-box">
								<?php content('CA', 'MA', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('CAMAPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="CALS" style="display:none" class="sub-category" class="sub-category">
							<h4 onclick="show('CALSP')" class="sub-sub-category">-- Presentations</h4>
							<div id="CALSP" style="display:none" class="media-box">
								<?php content('CA', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('CALSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('CALSV')" class="sub-sub-category">-- Videos</h4>
							...
							<h4 onclick="show('CALSPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="CAHB" style="display:none" class="sub-category">
							<h4 onclick="show('CAHBP')" class="sub-sub-category">-- Presentations</h4>
							<div id="CAHBP" style="display:none" class="media-box">
								<?php content('CA', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('CAHBMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="CAHBMS" style="display:none" class="media-box">
								<?php content('CA', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('CAHBV')" class="sub-sub-category">-- Videos</h4>
							<div id="CAHBV" style="display:none" class="media-box">
								<?php content('CA', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('CAHBPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="CACC" style="display:none" class="sub-category">
							<h4 onclick="show('CACCP')" class="sub-sub-category">-- Presentations</h4>
							<div id="CACCP" style="display:none" class="media-box">
								<?php content('CA', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('CACCMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="CACCMS" style="display:none" class="media-box">
								<?php content('CA', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('CACCV')" class="sub-sub-category">-- Videos</h4>
							<div id="CACCV" style="display:none" class="media-box">
								<?php content('CA', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('CACCPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="CABS" style="display:none" class="sub-category" class="sub-category">
							<h4 onclick="show('CABSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="CABSMS" style="display:none" class="media-box">
								<?php content('CA', 'BS', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('CABSPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
				...
				<div id="AUheading">
					...
					<div id="AUcontent" style="display:none">
						...
						<div id="AUMA" style="display:none" class="sub-category">
							<h4 onclick="show('AUMAP')" class="sub-sub-category">-- Presentations</h4>
							<div id="AUMAP" style="display:none" class="media-box">
								<?php content('AU', 'MA', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('AUMAMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="AUMAMS" style="display:none" class="media-box">
								<?php content('AU', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('AUMAV')" class="sub-sub-category">-- Videos</h4>
							<div id="AUMAV" style="display:none" class="media-box">
								<?php content('AU', 'MA', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('AUMAPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="AULS" style="display:none" class="sub-category" class="sub-category">
							<h4 onclick="show('AULSP')" class="sub-sub-category">-- Presentations</h4>
							<div id="AULSP" style="display:none" class="media-box">
								<?php content('AU', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('AULSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('AULSV')" class="sub-sub-category">-- Videos</h4>
							...
							<h4 onclick="show('AULSPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="AUHB" style="display:none" class="sub-category">
							<h4 onclick="show('AUHBP')" class="sub-sub-category">-- Presentations</h4>
							<div id="AUHBP" style="display:none" class="media-box">
								<?php content('AU', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('AUHBMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="AUHBMS" style="display:none" class="media-box">
								<?php content('AU', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('AUHBV')" class="sub-sub-category">-- Videos</h4>
							<div id="AUHBV" style="display:none" class="media-box">
								<?php content('AU', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('AUHBPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="AUCC" style="display:none" class="sub-category">
							<h4 onclick="show('AUCCP')" class="sub-sub-category">-- Presentations</h4>
							<div id="AUCCP" style="display:none" class="media-box">
								<?php content('AU', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('AUCCMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="AUCCMS" style="display:none" class="media-box">
								<?php content('AU', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('AUCCV')" class="sub-sub-category">-- Videos</h4>
							<div id="AUCCV" style="display:none" class="media-box">
								<?php content('AU', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('AUCCPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
				...
				<div id="OMheading">
					...
					<div id="OMcontent" style="display:none">
						...
						<div id="OMMA" style="display:none" class="sub-category">
							<h4 onclick="show('OMMAP')" class="sub-sub-category">-- Presentations</h4>
							<div id="OMMAP" style="display:none" class="media-box">
								<?php content('OM', 'MA', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('OMMAMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="OMMAMS" style="display:none" class="media-box">
								<?php content('OM', 'MA', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('OMMAV')" class="sub-sub-category">-- Videos</h4>
							<div id="OMMAV" style="display:none" class="media-box">
								<?php content('OM', 'MA', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('OMMAPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="OMLS" style="display:none" class="sub-category">
							<h4 onclick="show('OMLSP')" class="sub-sub-category">-- Presentations</h4>
							<div id="OMLSP" style="display:none" class="media-box">
								<?php content('OM', 'LS', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('OMLSMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							...
							<h4 onclick="show('OMLSV')" class="sub-sub-category">-- Videos</h4>
							...
							<h4 onclick="show('OMLSPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="OMHB" style="display:none" class="sub-category">
							<h4 onclick="show('OMHBP')" class="sub-sub-category">-- Presentations</h4>
							<div id="OMHBP" style="display:none" class="media-box">
								<?php content('OM', 'HB', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('OMHBMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="OMHBMS" style="display:none" class="media-box">
								<?php content('OM', 'HB', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('OMHBV')" class="sub-sub-category">-- Videos</h4>
							<div id="OMHBV" style="display:none" class="media-box">
								<?php content('OM', 'HB', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('OMHBPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
						...
						<div id="OMCC" style="display:none" class="sub-category">
							<h4 onclick="show('OMCCP')" class="sub-sub-category">-- Presentations</h4>
							<div id="OMCCP" style="display:none" class="media-box">
								<?php content('OM', 'CC', 'P', '', ''); ?>
							</div>
							<h4 onclick="show('OMCCMS')" class="sub-sub-category">-- Market &amp; Sales Material</h4>
							<div id="OMCCMS" style="display:none" class="media-box">
								<?php content('OM', 'CC', 'MS', '', ''); ?>
							</div>
							<h4 onclick="show('OMCCV')" class="sub-sub-category">-- Videos</h4>
							<div id="OMCCV" style="display:none" class="media-box">
								<?php content('OM', 'CC', 'V', '', ''); ?>
							</div>
							<h4 onclick="show('OMCCPL')" class="sub-sub-category">-- Pricelists / Local Content</h4>
